<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ygs_lys_puan_hesaplama1.aspx.cs" Inherits="duzSayfa_Default" %>
...
<!--LYS Tablo bitiş-->
<p><input onclick="getYGSGenel();" name="button2" type="button" value="HESAPLA" /> <input onclick="    setYGSFormTemizle();" name="button1" type="reset" value="TEMİZLE" /></p></p>
